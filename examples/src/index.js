...
ReactDOM.render(
    <CustomIconsExample />,
    document.getElementById('custom-icons-example'),
);
ReactDOM.render(
    <DisabledExample />,
    document.getElementById('disabled-example'),
);
ReactDOM.render(
    <NoCascadeExample />,
    document.getElementById('no-cascade-example'),
);
ReactDOM.render(
...
ReactDOM.render(
    <ClickableLabelsExample />,
    document.getElementById('clickable-labels-example'),
);
ReactDOM.render(
    <HiddenCheckboxesExample />,
    document.getElementById('hidden-checkboxes-example'),
);
ReactDOM.render(
    <ExpandAllExample />,
    document.getElementById('expand-all-example'),
);
ReactDOM.render(
    <LargeDataExample />,
    document.getElementById('large-data-example'),
);
